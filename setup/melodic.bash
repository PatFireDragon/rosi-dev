...
apt-get -y install python-catkin-tools ros-${ROSI_DISTRO}-brics-actuator ros-${ROSI_DISTRO}-tf2-sensor-msgs \
        ros-${ROSI_DISTRO}-joy ros-${ROSI_DISTRO}-joint-state-publisher
